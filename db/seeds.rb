...
40.times do
  ...
  new_recipe = Recipe.new({ name: recipe["strMeal"], description: recipe["strTags"]&.gsub(",", ", "), image_url: recipe["strMealThumb"], rating: rand(4.0..10.0).round(1), instruction: recipe["strInstructions"] })
  new_recipe.save
